...
void Engine::Button::Update(float deltaTime)
{
	...
	else if (Engine::ButtonState::NORMAL2 == state) {
		sprite->PlayAnim("normal2");
	}
	else if (Engine::ButtonState::HOVER2 == state) {
		sprite->PlayAnim("hover2");
	}
	else if (Engine::ButtonState::NORMAL3 == state) {
		sprite->PlayAnim("normal3");
	}
	else if (Engine::ButtonState::HOVER3 == state) {
		sprite->PlayAnim("hover3");
	}
	else if (Engine::ButtonState::NORMAL4 == state) {
		sprite->PlayAnim("normal4");
	}
	else if (Engine::ButtonState::HOVER4 == state) {
		sprite->PlayAnim("hover4");
	}
